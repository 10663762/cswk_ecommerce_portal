...
export default function ShoppingBag({...props}) {
    return (
        <svg 
            ...
            viewBox="0 0 44.36 48.82" 
            {...props}
        >
            <g data-name="Layer 2">
            <g data-name="Layer 1">
                <path fill="#ff491f" d="M37.17 48.82H0L3.77 12.5H33.4l.6 6.06Z" />
                <path fill="#ed3618" d="M19.09 24.24h20.59l2.62 24.58H16.47Z" />
                <path fill="#ffe14d" d="M21.15 24.24h20.59l2.62 24.58H18.53Z" />
                <path
                fill="#3c3f4d"
